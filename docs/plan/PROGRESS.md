...
**Next task:** 012 — Registration via invite URL
**Blocked on:** **the first-administrator question below must be answered before 012 can run end to end.**
An invite requires a creator, and no account exists to be one
