...
export const en = {
  ...
  table: {
    ...
    visibilities: { Public: 'Everyone', Private: 'Just me and the Master', MasterOnly: 'Only me' },
    joinFailed: 'This session is not open, or you are not at this table.',
    connecting: 'Connecting…',
    rejected: 'That could not be sent.',
  },
  notifications: {
    title: 'Notifications',
    none: 'Nothing new.',
