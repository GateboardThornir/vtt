...
export const it: typeof en = {
  ...
  characters: {
    title: 'Personaggi',
    none: 'Ancora nessun personaggio.',
    create: 'Crea un personaggio',
    name: 'Nome',
    open: 'Apri',
    save: 'Salva',
    saved: 'Salvato.',
    ...
    current: 'Attuali',
    maximum: 'Massimi',
    armourClass: 'Classe armatura',
    derived: 'Calcolato dal server',
    modifiers: 'Modificatori',
    savingThrows: 'Tiri salvezza',
    skills: 'Abilità',
    passivePerception: 'Percezione passiva',
    readOnly: 'Questi valori sono calcolati da quelli sopra e non si possono modificare.',
    notYours: 'Questo personaggio appartiene a qualcun altro.',
    notFound: 'Questo personaggio non esiste, oppure non puoi vederlo.',
    strength: 'Forza',
    dexterity: 'Destrezza',
  ...
  table: {
    ...
    say: 'Parla',
    message: 'Messaggio',
    inCharacter: 'Nel personaggio',
    outOfCharacter: 'Fuori dal personaggio',
    roll: 'Tira',
    expression: 'Dadi',
    visibility: 'Chi lo vede',
    visibilities: { Public: 'Tutti', Private: 'Solo io e il Master', MasterOnly: 'Solo io' },
    joinFailed: 'Questa sessione non è aperta, oppure non fai parte di questo tavolo.',
    connecting: 'Connessione…',
    rejected: 'Non è stato possibile inviare.',
  },
  notifications: {
    title: 'Notifiche',
